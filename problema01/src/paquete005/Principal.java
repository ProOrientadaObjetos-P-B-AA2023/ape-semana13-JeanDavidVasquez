...
public class Principal {
    public static void main(String[] args) {
        ...
        Persona persona= new Persona("JEAN", "VASQUEZ", 18,"1105822231",ciudad1);
        pago= new BilleteraPagos(persona,"ENERO",agua,luz,propiedades,telefono,gastosPagos.calcularGastoPagos());
